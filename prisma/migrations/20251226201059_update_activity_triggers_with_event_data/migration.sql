-- Update Event trigger to only handle pure event activities
...
-- Update Result trigger to include event data and prevent duplicates
...
-- Drop the UPDATE trigger for events (not needed anymore)
