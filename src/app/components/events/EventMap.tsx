...
const EventMap: React.FC<EventMapProps> = ({ location }) => {
  ...
  if (isLoading) {
    return (
      <div className='mb-4 h-full w-full animate-pulse overflow-hidden rounded-md bg-gray-200 dark:bg-neutral-700'>
  ...
  return (
    <div className='mb-4 h-full w-full overflow-hidden rounded-md'>
      {isMounted && position && (
        <>
          <LeafletCSS />
          <MapContainer
