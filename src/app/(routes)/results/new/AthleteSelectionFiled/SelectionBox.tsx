      ...
      >
        ...
        {selected === undefined && (
          <>
            ...
            <div
              className={
                'sm::grid-cols-2 grid h-50 w-full grid-cols-1 gap-4 overflow-y-scroll md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6'
              }
            >
              {athletes
                ...
                .map((athlete) => {
                  ...
                  return (
                    <div
                      key={id}
                      className={clsx(
                        'grid cursor-pointer grid-cols-2 items-center gap-4 rounded-lg border-1 border-gray-200 p-3 md:p-3',
                      )}
